/**
 * Program Name : largestBinarySearchTree
 * Topic        : Binary Search Tree (BST)
 * Difficulty   : Advanced
 * Concepts     : Bottom-up Postorder Traversal, BST Subtree Validation, Size Calculation
 * -------------------------------------------------------------
 * Description  :
 * Finds the size of the largest sub-tree in a Binary Tree that is a valid Binary Search Tree (BST).
 */
public class largestBinarySearchTree {
    ...
    public static void main(String[] args) {
        ...
        largestBST(root);
        System.out.println("Size of largest BST in given Binary Tree: " + maxBST);
    }
}
